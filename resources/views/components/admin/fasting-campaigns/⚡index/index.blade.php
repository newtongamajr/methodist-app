        ...
        <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700 text-sm">
            <thead class="bg-zinc-50 dark:bg-zinc-800/50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-start font-semibold">{{ __('Entries') }}</th>
            ...
            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                @forelse ($this->campaigns as $campaign)
                    <tr wire:key="campaign-{{ $campaign->id }}">
                        <td class="px-4 py-3">
                            <a href="{{ route('admin.fasting-campaigns.edit', $campaign) }}" class="font-medium text-[#c8202f] hover:underline dark:text-rose-300" wire:navigate>
                                {{ $campaign->name }}
                            </a>
                        ...
                        <td class="px-4 py-3">{{ $campaign->entries_count }}</td>
                        <td class="px-4 py-3">
