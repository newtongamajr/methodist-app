...
/**
 * Consolidated `user_permissions` table — alpha-01 baseline.
 *
...
CREATE TABLE `user_permissions` (
  ...
  KEY `user_permissions_model_id_model_type_index` (`model_id`,`model_type`),
...
SQL);
    ...
    {
        Schema::disableForeignKeyConstraints();
        DB::statement('DROP TABLE IF EXISTS `user_permissions`');
        Schema::enableForeignKeyConstraints();
    }
};
