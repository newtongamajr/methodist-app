...
/**
 * Consolidated `fasting_campaigns` table — alpha-01 baseline.
 *
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement(<<<'SQL'
CREATE TABLE `fasting_campaigns` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `fasting_campaigns_slug_unique` (`slug`),
  KEY `fasting_campaigns_is_active_start_date_end_date_index` (`is_active`,`start_date`,`end_date`)
...
SQL);
    ...
    {
        Schema::disableForeignKeyConstraints();
        DB::statement('DROP TABLE IF EXISTS `fasting_campaigns`');
        Schema::enableForeignKeyConstraints();
    }
};
