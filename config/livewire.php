...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Lift the temp-upload cap from the 12 MB default to 100 MB so
        // video uploads (admin posts editor + similar) don't silently
        // fail here before our per-field `mimetypes:video/...` rules
        // run. Aligned with PHP's upload_max_filesize / post_max_size
        // (both 100 M on this host). The per-field rules still enforce
        // the real per-type caps; this is the OUTER gate.
